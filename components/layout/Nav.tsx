...
export default function Nav() {
  ...
  return (
    <>
      {/* ─── Top bar ────────────────────────────────────── */}
      <header
        className="fixed top-0 left-0 right-0 z-50 h-[64px] md:h-[88px] flex items-center justify-between px-5 md:px-8 border-b border-border-subtle backdrop-blur-[20px] backdrop-saturate-[1.6]"
      ...
      >
        ...
        {/* Right: empty placeholder（モバイルでもバランスを取るため空 div） */}
